        ...
        <div class="col-md-4">
          <div class="dropdown float-right" id="mini-cart">
            <a
              ...
              <i
                ...
                style="font-size: 42px"><span class="cart-items">3</span></i>&ensp;
              <div class="d-inline-block text-dark">
                <span class="small d-block text-left">Your cart</span><span class="font-weight-bold">$3500.05</span>
              </div>
            </a>
          ...
          <div class="dropdown float-right" id="mini-user">
            <a
              ...
              <div class="d-inline-block text-dark">
                <span class="small d-block text-left">Tài khoản của tôi</span><span class="font-weight-bold">Đăng nhập/Đăng kí</span>
              </div>
            </a>

            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
              <a class="dropdown-item" href="login.php">Đăng kí</a>
          ...
          <ul class="navbar-nav mr-auto">
            <li class="nav-item dropdown Categories-dropdown">
              <a
                ...
                data-toggle="dropdown"
                aria-haspopup="true"
                aria-expanded="false"><i class="la la-bars"></i>&ensp;Categories
                    ...
                    <div class="col-md-12">
                      ...
                      <p class="well">
                        Returning Customer &nbsp;<a
                          href="#"
                          onclick="jQuery('.login-form').toggle();return false;">I am a returning customer</a>
                      </p>

                      <div
                        class="login-form registerbox clearfix"
                        style="display: none">
                        <div class="row">
                          ...
                          <form class="form-inline" role="form">
                            ...
                            <div class="form-group col-md-4">
                              <input
                                ...
                                type="button" />
                              <a
                                href="http://agency.nicolette.ro/index.php?route=account/forgotten">Forgotten Password</a>
                            </div>
                          </form>
                        </div>
                      </div>
                    ...
                    <div class="col-md-6 register_block">
                      <div class="row">
                        ...
                        <div class="form-group required col-md-6">
                          <label
                            class="form-control-label"
                            for="input-payment-firstname">First Name</label>
                          <input
                            name="firstname"
                            value=""
                        ...
                        <div class="form-group required col-md-6">
                          <label
                            class="form-control-label"
                            for="input-payment-lastname">Last Name</label>
                          <input
                            name="lastname"
                            value=""
...
-->
                        ...
                        <div class="form-group required col-md-12">
                          <label
                            class="form-control-label"
                            for="input-payment-address-1">Address 1</label>
                          <input
                            name="address_1"
                            value=""
                        ...
                        <div class="form-group col-md-12">
                          <label
                            class="form-control-label"
                            for="input-payment-address-2">Address 2</label>
                          <input
                            name="address_2"
                            value=""
                        ...
                        <div class="form-group required col-md-6">
                          <label
                            class="form-control-label"
                            for="input-payment-zone">Region / State</label>
                          <select
                            name="zone_id"
                        ...
                        <div class="form-group required col-md-6">
                          <label
                            class="form-control-label"
                            for="input-payment-postcode">Post Code</label>
                          <input
                            name="postcode"
                            value=""
                      ...
                      <div class="form-group">
                        <label class="custom-control custom-checkbox">
                          <input
                            ...
                            type="checkbox"
                            name="register"
                            onclick="if (this.checked == true) jQuery('.register-form').show(); else jQuery('.register-form').hide();" /><span class="custom-control-label"></span>
                      ...
                      <div class="register-form" style="display: none">
                        <div class="form-group required col-md-6">
                          <label
                            class="form-control-label"
                            for="input-payment-password">Password</label>
                          <input
                            name="password"
                            value=""
                            placeholder="Password"
                        ...
                        <div class="form-group required col-md-6">
                          <label
                            class="form-control-label"
                            for="input-payment-confirm">Password Confirm</label>
                          <input
                            name="confirm"
                            value=""
                    ...
                    <div class="col-md-6">
                      <div class="shiptobilling clearfix form-group">
                        ...
                        <label class="custom-control custom-checkbox">
                          <input
                            ...
                            value="new"
                            onclick="if (this.checked == true) jQuery('.shipping-address').show(); else jQuery('.shipping-address').hide();" /><span class="custom-control-label"></span>
                          <span class="custom-control-description">I want to use a new address
                          </span>
                        </label>
                      </div>
                      ...
                      <div class="shipping-address" style="display: none">
                        ...
                        <div id="shipping-new" style="display: block">
                          ...
                          <div class="form-group custom-field">
                            <label
                              class="form-control-label"
                              for="input-shipping-custom-field1">Custom field name account</label>
                            <div class="">
                              <input
                                name="shipping_custom_field[1]"
                                value="test"
                                placeholder="Custom field name account"
                                id="input-shipping-custom-field1"
                                class="form-control"
                                type="text" />
                            </div>
                          </div>
                          <div class="form-group custom-field">
                            <label
                              class="form-control-label"
                              for="input-shipping-custom-field2">Custom field name address</label>
                            <div class="">
                              <input
                                name="shipping_custom_field[2]"
                                value="Test"
                                placeholder="Custom field name address"
                                id="input-shipping-custom-field2"
                                class="form-control"
                                type="text" />
                            </div>
                          </div>
                      ...
                      <div class="your_order">
                        ...
                        <table
                          ...
                          <tbody>
                            <tr data-product>
                              <td class="text-xs-left">
                                <a
                                  href="http://agency.nicolette.ro/index.php?route=product/product&amp;product_id=33"
                                  data-url><span data-name>Samsung SyncMaster 941BW</span></a>
                              </td>
                          ...
                          <tfoot>
                            <tr>
                              <td
                                colspan="3"
                                class="text-xs-right hidden-xs-down">
                                <strong>Sub-Total:</strong>
                              </td>
                              <td
                                colspan="1"
                                class="text-xs-right hidden-sm-up">
                                <strong>Sub-Total:</strong>
                              </td>
                        ...
                        <div class="card card-default">
                          ...
                          <div
                            ...
                            <div class="card-block">
                              <label
                                class="form-control-label"
                                for="input-voucher">Enter your gift certificate code here</label>
                        ...
                        <div class="card card-default">
                          ...
                          <div
                            ...
                            <div class="card-block">
                              <label
                                class="form-control-label"
                                for="input-reward">Points to use (Max )</label>
                              <div class="input-group">
                                <input
                                  name="reward"
                                  value=""
                                  placeholder="Points to use (Max )"
                                  id="input-reward"
                                  class="form-control"
                                  type="text" />
                                <span class="input-group-btn">
                        ...
                        <div class="payment-method">
                          <p>
                            Please select the preferred payment method to use
                            on this order.
                          </p>
                          <div class="radio">
                            <label class="custom-control custom-radio">
                        ...
                        <div class="buttons clearfix">
                          <div class="float-xs-right">
                            ...
                            <a
                              href="http://agency.nicolette.ro/index.php?route=information/information/agree&amp;information_id=5"
