...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><b>QUẢN LÝ THÔNG TIN DANH MỤC</b></h1>
            </div>
        </div>
        ...
        <div class="panel-body">
            ...
            <button class="btn btn-success" style="margin-bottom: 20px;" onclick="window.open('add_or_edit_dm.php', '_self')">Thêm mới</button>
            <?php
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    if (isset($_GET['s']) && $_GET['s'] != '') {
                        $sql = 'SELECT * FROM danh_muc WHERE ten LIKE "%' . $_GET['s'] . '%"';
                    } else {
            ...
            <td>' . ($index++) . '</td>
            <td>' . $std['ten'] . '</td>
            <td><button class="btn btn-warning" onclick=\'window.open("add_or_edit_dm.php.?ID=' . $std['id'] . '","_self")\'>Sửa</button></td>
