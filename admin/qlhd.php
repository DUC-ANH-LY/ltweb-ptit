...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><b>QUẢN LÝ THÔNG TIN HÓA ĐƠN</b></h1>
            </div>
        </div>
        ...
        <div class="panel-body">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    if (isset($_GET['s']) && $_GET['s'] != '') {
                        $sql = 'SELECT * FROM hoa_don WHERE ten_khach_hang LIKE "%' . $_GET['s'] . '%"';
                    } else {
            ...
            <td>' . $std['mo_ta'] . '</td>
            <td>' . $std['ngay_mua'] . '</td>
            <td>' . currency_format($std['tong_tien']) . '</td>
            <td><button class="btn" onclick=\'window.open("chi_tiet_hoa_don.php.?ID=' . $std['id'] . '","_self")\'>Xem chi tiết</button></td>
