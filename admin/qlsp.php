...
<body>
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="admin.php"><span>Quản Lý</span> NHÀ CUNG CẤP </a>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><b>QUẢN LÝ THÔNG TIN SẢN PHẨM</b></h1>
            </div>
        </div>
        ...
        <div class="panel-body">
            ...
            <button class="btn btn-success" style="margin-bottom: 20px;" onclick="window.open('add_or_edit_sp.php', '_self')">Thêm mới</button>
            <?php
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    if (isset($_GET['s']) && $_GET['s'] != '') {
                        $sql = 'SELECT * FROM san_pham WHERE ten LIKE "%' . $_GET['s'] . '%"';
                    } else {
                    ...
                    $index = 1;
                    foreach ($List as $std) {
                        $nhacc = executeResult('SELECT * FROM nha_cung_cap where id = ' . $std['nha_cung_cap_id']);
            ...
            <td>' . $std['mo_ta'] . '</td>
            <td>' . $nhacc[0]['ten'] . '</td>
            <td>' . currency_format($std['gia_mua']) . '</td>
            <td>' . currency_format($std['gia_ban']) . '</td>
            <td>' . $std['so_luong'] . '</td>
            <td>' ?> <img src=".<?= $std['image'] == '' ? '/images/mayanh.jpg' : $std['image']  ?>" width="60%" height="60%" alt="sanpham"> <?php echo '</td>
            <td><button class="btn btn-warning" onclick=\'window.open("add_or_edit_sp.php.?ID=' . $std['id'] . '","_self")\'>Sửa</button></td>
